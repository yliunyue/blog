  ...
  routes: [
...

    {
      ...
      children: [
        ...
        {
          path: '/My',
          component: r => require.ensure([], () => r(require('@/views/My')), 'My')
        },
        {
          path: '/UpdateUser',
          component: r => require.ensure([], () => r(require('@/views/UpdateUser')), 'UpdateUser')
        },
        {
          path: '/Discuss',
          component: r => require.ensure([], () => r(require('@/views/Discuss')), 'Discuss')
        },
        {
          path: '/ContactUs',
          component: r => require.ensure([], () => r(require('@/views/ContactUs')), 'ContactUs')
        }
